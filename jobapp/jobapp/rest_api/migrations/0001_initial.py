    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_rest_api.job_set+', to='contenttypes.contenttype')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groupset', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='groupset_jobs', to='rest_api.groupset')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
